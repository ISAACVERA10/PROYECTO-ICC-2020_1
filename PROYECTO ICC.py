...
for i in range(numero_enemigos):
    ...
    ene_X.append(random.randint(0, 795))#50
...
for i in range(100):
    ...
    list_estrella.append([x, y])#[50,100]
...
while juego:
    ...
    for i in range(numero_enemigos):
        ...
        # colision_nave
        choque_nave = colision_nave(ene_X[i], ene_Y[i], posX, posY-25)
        if choque_nave:
            posX, posY = Ancho / 2.2, Alto - 80
            cambio_X = 0
            laser_Y = Alto - 80
